...
# proxy_support = urllib.request.ProxyHandler({'http': '138.185.255.74:53281'})
# opener = urllib.request.build_opener(proxy_support)
# urllib.request.install_opener(opener)

# print (urlopen("http://web.ifzq.gtimg.cn").read().decode('GBK'))
# #http://market.finance.sina.com.cn/downxls.php?
# print (urlopen("http://market.finance.sina.com.cn/downxls.php?").read().decode('GBK'))
